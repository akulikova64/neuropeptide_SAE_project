...
# --- Outputs ---
TSV_FILE="../../data/fig_6_zebrafish_secretome/secratome_annotations_zebrafish.tsv"
CSV_FILE="../../data/fig_6_zebrafish_secretome/secratome_annotations_zebrafish.csv"

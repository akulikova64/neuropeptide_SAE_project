...
homology = [40, 50, 60, 70, 80, 90]

for hom in homology:

    base_dir    = f"/Volumes/T7 Shield/toxin_dataset/toxins_and_neuro/F1_scores_hybrid/homology_group{hom}"
    output_file = f"/Volumes/T7 Shield/toxin_dataset//toxins_and_neuro/F1_scores_hybrid/winning_thresholds_neuro_toxins_hom{hom}.csv"

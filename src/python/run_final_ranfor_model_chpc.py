...
# ─── Paths ────────────────────────────────────────────────────────────────
MODEL_PATH = "./output_models/final_all_folds/rf_final_allfolds_features_70.joblib"
EMB_DIR    = "../known_peptides_SAE_embeddings"
FASTA_PATH = "./input_files/uniprot_known_neuropep_sequences.fasta"

RANKING_ALL_FOLDS = f"./input_files/F1_scores_graphpart_{percent_identity}/feature_ranking_all_folds.csv"

POS_CSV_OPT = "./input_files/group_2_positive_known_peps.csv"

OUT_CSV  = f"./output_csv_files/known_peptides_rf_probs_predictions_{num_features}.csv"
OUT_SUM  = f"./output_csv_files/known_peptides_rf_summary_{num_features}.csv"
OUT_FEAT = f"./output_csv_files/known_peptides_rf_features_used_{num_features}.json"

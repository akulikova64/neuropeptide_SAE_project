# R markdown file scripts

### Main figure scripts
- `Figure_1_PCA.Rmd` — complete code for Figure 1
- `Figure 2` — schematic (no code)
- `figure_3.Rmd` — complete code for Figure 3
- `figure_5.Rmd` — complete code for Figure 3
- `Figure 4` — schematic (no code)
- `figure_6.Rmd` — complete code for Figure 3
